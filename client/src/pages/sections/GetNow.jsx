...
const GetNow = () => {
  return (
    <section className='w-large 2xl:w-xLarge mx-auto flex flex-col items-center text-center font-montserrat mt-20 lg:hidden'>
        <div className=''>
            ...
            <button className='bg-primary text-black mb-5 px-[45px] py-[5px] rounded-[5px]'>Get now!</button>
        </div>

        <div className=' flex justify-center items-end'>
            <img className='' src={Book1} alt="book" />
            <img className='' src={Book2} alt="book" />
            <img className='' src={Book3} alt="book" />
            <img className='' src={Book4} alt="book" />
        </div>
    </section>
  )
}
