...
const Navbar = () => {
  return (
    <nav className='bg-white sm:bg-yellow-300 pt-11 pb-5 md:bg-green-500 lg:bg-red-400 xl:bg-teal-500 2xl:bg-purple-400'>
      <main className='flex items-center w-[90%] mx-auto justify-between gap-4'>
